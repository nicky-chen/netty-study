package com.nicky.nettystudy.demo.test10.protocol;

import java.util.HashMap;
import java.util.Map;

import com.nicky.nettystudy.demo.test10.protocol.request.CreateGroupRequestPacket;
import com.nicky.nettystudy.demo.test10.protocol.request.GroupMessageRequestPacket;
...
import com.nicky.nettystudy.demo.test10.protocol.request.LoginRequestPacket;
...
import com.nicky.nettystudy.demo.test10.protocol.request.QuitGroupRequestPacket;
import com.nicky.nettystudy.demo.test10.protocol.response.CreateGroupResponsePacket;
import com.nicky.nettystudy.demo.test10.protocol.response.GroupMessageResponsePacket;
import com.nicky.nettystudy.demo.test10.protocol.response.JoinGroupResponsePacket;
import com.nicky.nettystudy.demo.test10.protocol.response.ListGroupMembersResponsePacket;
import com.nicky.nettystudy.demo.test10.protocol.response.LoginResponsePacket;
import com.nicky.nettystudy.demo.test10.protocol.response.LogoutResponsePacket;
import com.nicky.nettystudy.demo.test10.protocol.response.MessageResponsePacket;
import com.nicky.nettystudy.demo.test10.protocol.response.QuitGroupResponsePacket;
import com.nicky.nettystudy.demo.test10.serialize.Serializer;
import com.nicky.nettystudy.demo.test10.serialize.impl.JSONSerializer;

import io.netty.buffer.ByteBuf;

import static com.nicky.nettystudy.demo.test10.protocol.command.Command.CREATE_GROUP_REQUEST;
import static com.nicky.nettystudy.demo.test10.protocol.command.Command.CREATE_GROUP_RESPONSE;
import static com.nicky.nettystudy.demo.test10.protocol.command.Command.GROUP_MESSAGE_REQUEST;
...
import static com.nicky.nettystudy.demo.test10.protocol.command.Command.LIST_GROUP_MEMBERS_REQUEST;
...
import static com.nicky.nettystudy.demo.test10.protocol.command.Command.MESSAGE_REQUEST;
